						...
						<fieldset>
							...
							<div class="msg-line">
								<textarea id="txt-mobphones" name="txt-mobphones"
									class="msg-text span9" rows=2 onblur="validateMobphones()"></textarea>
								<br />
								<p>
									<span>输入格式：多个员工姓名请用逗号（,）隔开，比如：<span style="color: red">张三,李四</span>。</span>
								</p>
							</div>
							<label class="input-label">
								短信内容：
							...
							<div class="msg-line">
								<textarea id="txt-mobcontent" name="txt-mobcontent"
									class="msg-text span9" rows=5 onkeyup="validateMsgContent();"
									onkeydown="validateMsgContent()"
									onblur="validateMsgContent()"></textarea>
								<br />
								<p><span id="info-mobcontent" style="color: red"></span>
